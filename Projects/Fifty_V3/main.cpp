...
//Version 3 now implements floats(win rate), math functions, bool operator
...
int main(int argc, char** argv) {
    ...
    rules = "This program will simulate the dice game Fifty which requires "
            ...
            "points.";
    p1Doub=0; //starting value for wins
    p2Doub=0; //starting value for wins
    turns=0;  //turns amount
